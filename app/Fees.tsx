...
const Fees: React.FC = () => {
  ...
  const renderFeeItem = ({ item }: { item: FeeSummary }) => (
    ...
    >
      ...
      <Text
        style={[styles.feeCell, styles.paid]}
      >{`₹${item.amountPaid.toLocaleString()}`}</Text>
      <Text
        style={[styles.feeCell, styles.due]}
      >{`₹${item.amountDue.toLocaleString()}`}</Text>
      <Text
        style={[
  ...
  const renderPaymentItem = ({ item }: { item: FeeSummary }) => (
    <View style={styles.paymentRow}>
      <Text style={styles.paymentCellName}>{item.name}</Text>
    ...
    >
              ...
              <View style={styles.pickerContainer}>
                <Picker
                  ...
                  onValueChange={(itemValue) =>
                    setSelectedStudentId(Number(itemValue))
                  }
                >
      ...
      <View style={styles.summaryContainer}>
        ...
        <View style={[styles.summaryCard, styles.collectedCard]}>
          ...
          <Text style={styles.summaryPercent}>
            {totalFees > 0
              ? `${Math.round((totalCollected / totalFees) * 100)}% of total`
              : "0% of total"}
          </Text>
        </View>
      ...
      <View style={styles.filterContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert("Export", "Export functionality not implemented")
          }
        >
      ...
      {showTable && (
        <>
          ...
          <View style={styles.tableHeader}>
            <Text style={[styles.tableHeaderCell, styles.feeCellName]}>
              Student
            </Text>
            <Text style={[styles.tableHeaderCell, styles.feeCellCategory]}>
              Category
            </Text>
          ...
          <View style={[styles.tableHeader, { backgroundColor: "#e2e8f0" }]}>
            <Text style={[styles.tableHeaderCell, styles.paymentCellName]}>
              Student
            </Text>
      ...
      <View style={styles.resultsInfo}>
        <Text style={styles.resultsText}>
          Showing{" "}
          <Text style={styles.resultsCount}>{filteredFeeSummary.length}</Text>{" "}
          results
        </Text>
      </View>
    </ScrollView>
